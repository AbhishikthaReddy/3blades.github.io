...
1. Fork `https://github.com/3blades/3blades.github.io` repository to your user organization.
1. Clone your copy of `https://github.com/your-username/3blades.github.io` onto your machine using
`git clone https://github.com/your-username/3blades.github.io`.
1. Specify a new remote upstream repository that will be synced with the fork: `git remote add upstream https://github.com/3blades/3blades.github.io`.
